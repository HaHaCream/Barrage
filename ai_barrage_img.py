...
draw.text((300, 200), '我带你们打阿', '#600', font=font)
draw.text((300, 300), '真就打鸣阿都', '#060', font=font)
draw.text((300, 400), 'A1高闪来一个', '#006', font=font)
draw.text((300, 500), '秋梨膏！', '#606', font=font)
