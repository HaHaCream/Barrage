...
barrages_all = [
    ...
    ('哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈', 15),
    ('哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈', 10),
    ('哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈', 20),
    ('哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈', 24),
    ('哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈', 3),
    ('哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈', 17),
    ('哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈', 8),
    ('哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈', 30),
    ('哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈', 24),
    ('我没有', 12),
    ('38', 9),
    ('这毒，我！不！戒！', 15),
    ...
    ('喵酱我的！！！', 7),
    ('小孩子才全都要！我只要喵酱。', 80),
    ('我都一直会想，啊，想默默练习给大家一个惊喜这件事恐怕是不行了～这支舞对于我非常有挑战，激发起了我全部的热情和', 93),
    ('颜表立', 32),
    ('欢迎回来，颜表立', 6),
    ('小孩子才做选择，我全都要', 14),
    ('全程看红色', 126),
...
# 读取视频文件（需自行提供）
cap = cv2.VideoCapture('leijun.mp4')
...
wait = int(1000/int(fps)) #Compute the time to wait between each frame query
...
barrages_active = []
# 创建字体（可在项目中获取，或自行提供）
font = ImageFont.truetype('../zhaozi.ttf', 32)
#创建videowriter对象
fourcc = cv2.VideoWriter_fourcc('X','V','I','D')
out = cv2.VideoWriter("newleijun.avi",fourcc, fps, (width,height))

# 视频循环
while cv2.waitKey(wait) < 0:
    # 获取帧图像
